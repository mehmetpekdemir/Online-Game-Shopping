...
<body>
	...
	<% } else { %>
		...
		<h3 class="text-info">Kategori Düzenle</h3>
		...
		<form method="POST" action="${pageContext.request.contextPath}/editCategory">
			...
			<table class="table table-dark table-striped font-weight-bold">
				...
				<tr>
					<td>Kategori Adı : </td>
					<td ><input class="form-control font-weight-bold" type="text" name="categoryName"  /></td>
				</tr>
				
				<tr>
					<td></td>
					<td colspan="2"><input class="btn btn-success" type="submit" value="Kaydet" /> 
					<a class="btn btn-danger" href="${pageContext.request.contextPath}/listCategory">İptal Et</a></td>
				</tr>
			</table>
		</form>
	<%} %>
