...
<body>
	...
	<% } else { %>
		<h3 class="text-info">Kategori Listesi</h3>
		
		<div style= "margin:10px;">
			<a class="badge badge-pill badge-success" href="createCategory">Yeni Kategori Oluştur</a>
		</div>
			...
			<table class="table table-dark table-striped">
				...
				<c:forEach items="${platform.categories}" var="category">
					...
					<td><a class="badge badge-pill badge-danger" href="editCategory?id=${category.id}&platformName=${category.platformName}">Kategoriyi Düzenle</a></td>
				</tr>
				</c:forEach>
			</table>
