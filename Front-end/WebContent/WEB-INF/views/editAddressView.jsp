...
<head>
	...
	<title>Adres Düzenleme</title>
</head>
<body>
<jsp:include page="_header.jsp"></jsp:include>
	<jsp:include page="_menu.jsp"></jsp:include>

	<h3 class="text-info" >Adres Düzenleme</h3>

	<form method="POST" action="${pageContext.request.contextPath}/editAddress?id=${address.id}">
		<table class="table table-dark table-striped font-weight-bold">
			...
			<tr>
				...
				<td><input class="form-control font-weight-bold" type="text" name="addressDetail" value="${address.addressDetail}" required="required" height="150px" width="300px"></td>
			</tr>
			<tr>
				<td>Şehir :</td>
			...
			<tr>
				<td>Posta Kodu :</td>
				<td><input class="form-control font-weight-bold" type="number" name="postCode" value="${address.postCode}" required="required"></td>
			</tr>
			<tr>
				<td></td>
