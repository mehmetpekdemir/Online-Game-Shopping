...
<body>
	...
	<% } else { %>
		...
		<h3 class="text-info">Platform Düzenle</h3>
		...
		<form method="POST" action="${pageContext.request.contextPath}/editPlatform">
			...
			<table class="table table-dark table-striped font-weight-bold">
				...
				<tr>
					<td>Platform Adı : </td>
					<td><input class="form-control font-weight-bold" type="text" name="platformName" value="${platforms.platformName}" /></td>
				</tr>
				<tr>
					<td></td>
					<td colspan="2"><input class="btn btn-success" type="submit" value="Kaydet" /> 
					<a class="btn btn-danger" href="${pageContext.request.contextPath}/listPlatform">İptal Et</a></td>
				</tr>
			</table>
		</form>
	<%} %>
