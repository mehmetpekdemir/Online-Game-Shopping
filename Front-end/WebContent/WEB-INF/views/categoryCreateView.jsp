...
<body>
	...
	<h3 class="text-info">Kategori Oluştur</h3>
	...
	<form method="POST" action="${pageContext.request.contextPath}/createCategory">
		<table class="table table-dark table-striped font-weight-bold">
			<tr>
				<td>Platform Adı : </td>
				<td>
					<select class = "custom-select text-white bg-dark" name="platformName">
			...
			<tr>
				<td>Kategori Adı : </td>
				<td><input class="form-control font-weight-bold" type="text" name="categoryName" required="required" /></td>
			</tr>
			<tr>
				<td></td>
